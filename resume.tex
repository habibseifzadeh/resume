...
\mainbar{
    \section{About Me}
    I am Habib, a developer and software engineer who not only have extensive experience in IT industry, but also always keen to update my knowledge by using state-of-the-art technologies in the projects. I am able to deliver a wide range of products based on customers' needs, from fast-delivered Wordpress websites to high-quality ones using sophisticated frameworks and tools.
    ...
    \achievement{Created a generic e-shop system so that it be applied to nearly every business with minimun code change (Have been sold to 5 different businesses)}
    \achievement{Developed REST APIs to make a VB6 legacy system to be useful again}
    \achievement{Performed international projects (e.g., from Canada, Iceland and Australia)}
    \achievement{Led a team of researchers to do a successful piece of research for Isfahan Municipality to migrate their systems to open-source and reduce their costs}
    \achievement{Improved several programs' performances to give their users satisfaction}
    \achievement{Established continuous integration tools to reduce the deployment people}
